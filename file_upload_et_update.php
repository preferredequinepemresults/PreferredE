...
<h1 style="text-align:center;color:#D98880;">STANDARD BRED ET UPDATE FILE UPLOAD</h1>
<hr>
...
<form class="form-horizontal" action="import_csv_et_update.php" method="post"
...
<div style="text-align:left;align:left;font-size: 12px;">
    	...
    	<div class="table" style="width: 15%;align:right;">
            ...
            <div class='row'>
              ...
              <div class="cell">"ET" varchar(1) </div> </div>
        </div>
    </div>
